...
Note: Some services are paid and require billing setup. When you add more API keys to `.env`, you need to restart the server in step 2. On start, it'll automatically detect what API keys are available, and start those respective MCP servers.
